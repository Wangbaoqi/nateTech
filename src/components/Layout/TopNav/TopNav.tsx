...
function NavItem({url, isActive, target, children}: any) {
  return (
        ...
        <nav
          ...
          <div className="h-16 w-full gap-0 sm:gap-3 flex items-center justify-between">
            ...
            <div className="flex items-center -space-x-2.5 xs:space-x-0 ">
              <div className="hidden md:flex flex-1 justify-center items-center w-40 3xl:w-40 3xl:shrink-0 3xl:justify-center">
                <button
                  type="button"
                  className={cn(
                    'flex 3xl:w-[56rem] 3xl:mx-0 relative pl-4 pr-1 py-1 h-10 bg-gray-30/20 dark:bg-gray-40/20 outline-none focus:outline-link betterhover:hover:bg-opacity-80 pointer items-center text-left w-40 text-gray-30 rounded-full align-middle text-base'
                  )}
